...
$(document).on('keydown', function(e) {if ($('#discipline-overlay').length && !$('.sarcasm').length && e.keyCode==w[cw++]) {if(cw==w.length){cw=0;$('#discipline-overlay header').after('<div class="dcontainer sarcasm" ng-repeat="disc in disciplines"><h1 class="ng-binding"><span>+</span> &nbsp;Sarcasm</h1><p style="display:none;" class="ng-binding">We never employ sarcasm in any way shape or form. We don\'t think there is space for humour in a professional workplace, and sarcasm is the lowest form of humour. Sarcasm is basically lying, and there has been a starting trend in the advertising industry where more and more agencies adopt this baseless form of joke-lying. If you work with Red Lion, you can rest assured that none of this disgusting form of humour will be employed. <br/>#stopsarcasm</p></div>').click();$('#blackout').animate({'scrollTop':0},500)}} else {cw=0;}});
//overlay end